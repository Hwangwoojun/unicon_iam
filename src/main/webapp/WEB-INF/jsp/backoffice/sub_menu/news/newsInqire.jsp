                    ...
                    <div class="modify_user" >
                        <table>
                          <tr> 
					        ...
					        <td width="85%" colspan="5" nowrap="nowrap"><c:out value="${result.nttSj}" /> / <c:out value="${result.nttSjEng}" />
					        </td>
					      </tr>
					      <tr> 
					      ...
					      <tr> 
					        ...
					        <td colspan="5">
					         ...
					         <div id="bbs_cn">
					           <textarea id=nttCnEng name="nttCnEng"  cols="75" rows="20"  style="width:99%" readonly="readonly" title="글내용"><c:out value="${result.nttCnEng}" escapeXml="true" /></textarea>
					         </div>
					        </td>
					      </tr>
					      <c:if test="${not empty result.atchFileId}">
					          ...
					          <tr> 
					      <th width="15%" height="23" nowrap >URL</th>
					        <td colspan="5">
					            <c:out value="${result.nttUrl}" />
					        </td>
					      </tr>
					      </c:if>
