                        ...
                        <table>
					      <tr> 
					        ...
					        <th width="20%" height="23"  nowrap="nowrap"><label for="nttSjEng">영문 제목</label>
						        ...
						        <td width="80%" nowrap>
						          <input id="nttSjEng"  name="nttSjEng" type="text" size="60" value="<c:out value="${result.nttSjEng}" />"  maxlength="60" > 
					      ...
					      <tr> 
					        ...
					        <th height="23" ><label for="nttCnEng">영문 내용</label>
						        ...
						        <td>
						          <textarea id="nttCnEng" name="nttCnEng" class="textarea" cols="75" rows="20" style="width:99%;"><c:out value="${result.nttCnEng}" escapeXml="false" /></textarea> 
						          <form:errors path="nttCnEng" />
						        </td>
					      </tr>
					      <tr>
					      	 <th height="23"  nowrap="nowrap" colspan="1"><label for="nttUrl">링크URL</label>
                                <img src="<c:url value='/images/required.gif' />" width="15" height="15" alt="required" />
                             </th>
                             <td width="70%" nowrap colspan="3">
						         <input id="nttUrl" name="nttUrl" type="text" size="80" value="<c:out value="${result.nttUrl}" />"  maxlength="60" > 
