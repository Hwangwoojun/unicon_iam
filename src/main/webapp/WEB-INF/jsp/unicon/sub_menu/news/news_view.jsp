...
<div id="mainContent" class="container g${gNum} s${sNum}">
	...
	<div class="inner">
		<div class="board_view">
			<div class="tit"><c:out value="${result.nttSj}" />
				<div class="date">
					<dl>
						<dt>등록일</dt>
			...
			<div class="con">
				...
				링크URL : <a href='<c:out value="${result.nttUrl}" />' target="_blank"><c:out value="${result.nttUrl}" /></a>
			</div>
			</div>
			<!-- <div class="prev_next">
			...
			<a href="/kr/news/news" class="btn_list">목록</a>
		</div>
	</div>
