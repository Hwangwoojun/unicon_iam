...
function fn_inqire_notice(nttId,bbsId) {
    ...
    document.subForm.action = "<c:url value='/kr/publication/publication_view'/>";
...
<div id="mainContent" class="container g${gNum} s${sNum}">
	...
	<div class="inner">
		<form name="searchfrm" method="post" action="/kr/publication/publication">
		...
		<form name="subForm" method="post" action="<c:url value='/kr/publication/publication_view'/>">
...
<div id="mainContent" class="container g${gNum} s${sNum}">
	...
	<div class="inner">
		<form name="searchfrm" method="post" action="<c:url value='/kr/publication/publication'/>">
			<div class="board_top">
				<div class="total">총 <strong>${resultCnt}</strong>건</div>
				<div class="search_area"><!-- 검색영역 미사용 --></div>
			</div>
		</form>
