...
<div id="mainContent" class="container g${gNum} s${sNum}">
	...
	<div class="inner">
		<div class="board_view">
			<div class="tit"><c:out value="${result.nttSjEng}" />
				<div class="date">
					<dl>
						<dt>Registration</dt>
			...
			<div class="con">
				...
				<c:out value="${result.nttCnEng}" escapeXml="true" />
				</p>
				
				LinkURL : <a href='<c:out value="${result.nttUrl}" />' target="_blank"><c:out value="${result.nttUrl}" /></a>
			</div>
			</div>
			<!-- <div class="prev_next">
				<div class="prev"><span>이전글</span><a href="javascript:void(0);">이전글이 없습니다.</a></div>
				<div class="next"><span>다음글</span><a href="javascript:void(0);">다음글이 없습니다.</a></div>
			</div> -->
			<a href="/eng/news/news" class="btn_list">List</a>
		</div>
	</div>
