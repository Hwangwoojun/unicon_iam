...
function fn_inqire_notice(nttId,bbsId) {
    ...
    document.subForm.action = "<c:url value='/eng/news/news_view'/>";
...
<div id="mainContent" class="container g${gNum} s${sNum}">
	<div class="title">${sName}</div>
		...
		<c:forEach var="result" items="${resultList}" varStatus="status">
			 <form name="subForm" method="post" action="<c:url value='/eng/news/news_view'/>">
			 <li>
                 ...
                 <a href="#LINK" onclick="javascript:fn_inqire_notice('<c:out value="${result.nttId}"/>','<c:out value="${result.bbsId}"/>'); return false;">
                     <span class="imgfit">
                      ...
                      <p style="text-align: center;"><c:out value="${result.nttSjEng}" /></p>
