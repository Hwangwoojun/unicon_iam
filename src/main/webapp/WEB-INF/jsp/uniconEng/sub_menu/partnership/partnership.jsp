			...
			<div class="box">
				...
				<div class="con">
					<ul>
						...
						<li><span>· 2024. 11. 04-06. (예정)</span>2024 17th IAMC 연례회의 (연세대, 한국)</li>
						<li><span>· 2024. 11. 07.(예정)</span>동북아 IAM 개발에 관한 국제 워크숍 (서울, 한국)</li>
						<li><span>· 2024. 11. 08.(예정)</span>기후변화와 순환경제에 관한 IAM 국제 워크숍 (서울, 한국)</li>
			...
			<div class="box">
				...
				<div class="con">
					<ul>
						...
						<li><span>· 2024. 11. 04. - 06. (예정)</span>(해외) 2024 17th IAMC 연례회의</li>
						<li><span>· 2024. 12. (예정)</span>(해외) 2024 미국 지질 물리학회 연례 국제 학술회의</li>
					</ul>
				</div>
			</div>
			<div class="box">
				...
				<div class="con">
					<ul>
						<li><span>· 2024. 12. (예정)</span>홍콩과학기술대 광저우 캠퍼스 (중국)</li>
					</ul>
				</div>
			</div>
<!-- 			<div class="box">
