...
public class EgovMainController {
	...
	@RequestMapping(value = "/kr/mainUnicon")
	public String getUniconMainPage(HttpServletRequest request, ModelMap model)
	  throws Exception{

		model.addAttribute("gNum", "main");


		// 공지사항 메인컨텐츠 조회 끝 -----------------------------------

		return "unicon/UniconMainKor";
	}
	
	@RequestMapping(value = "/eng/mainUnicon")
	public String getUniconEngMainPage(HttpServletRequest request, ModelMap model)
	  throws Exception{
		...
		return "uniconEng/UniconMainEng";
	}
