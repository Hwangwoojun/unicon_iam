...
public class Board implements Serializable {
	...
	private String nttCnEng = "";
	
	private String nttUrl = "";
	/**
	 * 게시물 아이디
	 */
	...
	public String getNttCnEng() {
		return nttCnEng;
	}

	public void setNttCnEng(String nttCnEng) {
		this.nttCnEng = nttCnEng;
	}

	public String getNttUrl() {
		return nttUrl;
	}

	public void setNttUrl(String nttUrl) {
		this.nttUrl = nttUrl;
	}

	public String getNttSjEng() {
		return nttSjEng;
	}

	public void setNttSjEng(String nttSjEng) {
		this.nttSjEng = nttSjEng;
	}
